...
<head>
    ...
    <title>hotel Housekeeping Management System</title>
    <link rel="stylesheet" href="./static/style.css">
    <script src="./script/script.js"></script>
    <link rel="shortcut icon" href="./images/hotel.png" type="image/png">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="navs">
        <div class="container-fluid">
            <a id="nav_admin" class="navbar-brand"><img style="width: 50px;" src="./images/hotel.png" alt=""></a>
